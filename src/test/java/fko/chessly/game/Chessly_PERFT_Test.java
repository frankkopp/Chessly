...
public class Chessly_PERFT_Test {
    ...
    public void testKiwipetePerft() {
        ...
        Chessly_PERFT perftTest = new Chessly_PERFT("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -");
    ...
    public void testSharper2Perft() {
        ...
        Chessly_PERFT perftTest = new Chessly_PERFT("8/3K4/2p5/p2b2r1/5k2/8/8/1q6 b - - 1 67");
    ...
    public void testPos3Perft() {
        ...
        Chessly_PERFT perftTest = new Chessly_PERFT("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -");
    ...
    public void testPos5Perft() {
        ...
        Chessly_PERFT perftTest = new Chessly_PERFT("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8");
